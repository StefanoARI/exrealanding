  ...
  return (
    <section id="faq" className="py-16 md:py-24 bg-slate-900/40 border-b border-slate-800/80 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className={`p-1 rounded-md bg-slate-800 text-slate-400 shrink-0 transition-transform ${isOpen ? 'rotate-180 text-cyan-400' : ''}`}>
                    <ChevronDown className="w-4 h-4" />
                  </div>
                </button>

                {isOpen && (
                  <div className="px-5 pb-5 pt-1 text-xs sm:text-sm text-slate-300 leading-relaxed border-t border-slate-800/60 animate-in fade-in slide-in-from-top-1">
                    <p>{faq.answer}</p>
        ...
        <div className="mt-10 p-5 rounded-xl bg-slate-900 border border-slate-800 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="shrink-0 px-4 py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-cyan-300 border border-slate-700 text-xs font-bold transition flex items-center gap-1.5"
          >
